...
<Typewriter cascade interval={20}>
  <br />
    ...
    <p class="MsoNormal">Suffers from delusions of grandeur; claims his grandfather’s name on his birth certificate is incorrect.</p>
    <p class="MsoNormal">Connection to <span class="text-delta-green">Joseph Curwin</span>?</p>
    <p class="MsoNormal">In therapy since age 13, based in Providence, Rhode Island.</p>
